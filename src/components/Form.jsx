...
export function Form() {
    ...
    const validaForm = (e) => {
        ...
        if (email === "" || password === "") {
            setMsg("prencha os campos vazios");
            setTimeout(() => {
                setMsg("");
            }, 3000);
            return false;
    ...
    return (
        <div className="flex flex-col gap-7 min-w-[375px] max-w-[572px] items-center">
            ...
            <form action="" className="flex flex-col w-[335px]">
                ...
                <button type="submit" href="#" className="py-3 bg-form-textTitle hover:bg-form-primaryColor text-form-background flex items-center justify-center rounded font-semibold mb-3"
                    onClick={validaForm}
                >ENTRAR</button>
